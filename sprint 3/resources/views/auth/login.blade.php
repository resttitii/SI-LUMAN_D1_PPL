            ...
            @csrf
                <div>
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="username" id="username" placeholder="John Doe" class="form-control @error('username') is-invalid @enderror" style="font-size: 14px; height: 55px; border: 1px solid #ddd;">
                        @error('username')
                    ...
                    <p class="text-center mb-0 mt-2" style="font-size: 13px">Belum punya akun? <a href="{{ route('register') }}">Daftar disini.</a></p>
                </div>
            </form>
        </div>
    </div>
