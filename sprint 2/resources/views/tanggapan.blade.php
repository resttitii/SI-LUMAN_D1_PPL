        ...
        <div class="col-xl-7 col-11 card p-0 mt-4" style="height: 80vh;">
            <div class="card-body px-4 py-4" style="overflow-y: auto">
                <div class="justify-content-between align-items-center">
                    <p>
                        <a href="{{ route('konsultasi') }}" class="text-dark" style="text-decoration: none"><i data-feather="arrow-left"></i> Kembali</a> <!--jika tidak jadi menanggapi maka bisa klik kembali-->
                    </p>
                    <div>
                        <h5 style="font-weight: bold">
                            Pertanyaan dari <span class="text-warning">{{ $keluhan->user->username }}</span> <!--halaman tanggapan akan dilengkapi identitas user yang memiliki keluhan berserta role masing-masing-->
                        </h5>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @if (auth()->user()->role == 'dokter') <!--edit tanggapan hanya untuk dokter yang bisa akses-->
                                <li><a href="{{ url('/edit_tanggapan/'.$item->tanggapan_id.'/'.$item->keluhan->keluhan_id) }}" class="dropdown-item">Edit</a></li>
                                @endif
                            </ul>
                            
                            <!-- Modal --> <!--menghapus tanggapan yang telah diinputkan-->
                ...
                <div class="col-12 text-center">
                    ...
                    <p class="text-muted">Belum ada data tanggapan</p> <!--tampilan halaman jika belum terdapat data tanggapan-->
                </div>
                
                @endif
            </div>
            @if (auth()->user()->role != 'admin') <!--role admin tidak memiliki akses untuk menggunakan fitur konsultasi-->
                
            <div class="card-footer text-end">
                <a href="{{ url('/tambah_tanggapan/'.$keluhan->keluhan_id) }}" class="btn btn-success px-3" style="font-size: 12px">+</a>
                @if (auth()->user()->role != 'dokter') <!--untuk konsultasi lanjutan hanya untuk pelanggan dan peternak-->
                <a href="{{ route('konsultasi_lanjutan') }}" class="btn btn-warning ms-1" style="font-size: 12px">Konsultasi Lanjutan</a>
                @endif
            </div>
