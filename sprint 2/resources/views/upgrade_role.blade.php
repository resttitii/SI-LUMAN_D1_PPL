@extends('layouts.app')
<!--upgrade role hanya untuk role pelanggan-->
@section('content')
        ...
        <div class="row justify-content-center align-items-start">
            <div class="col-xl-5 col-10 p-4 rounded mb-5 position-relative" style="background: #fff; top: 40px">
                <div>
                    ...
                    <div class="mt-3">
                        <label for="name" style="font-size: 14px;">Role saat ini</label> <!--informasi terkait current role-->
                    ...
                    <a href="mailto:infosiluman@gmail.com?subject=Upgrade%20Role"> <!--diarahkan ke email infosiluman-->
                        <button class="btn text-light mt-4" style="width: 100%; height: 50px; background: #1e1c1c">
                            Kirim Email
                        </button>
                    </a>
                    
                    <p class="text-secondary mt-1" style="font-size: 12px"> <!--setelah diarahkan ke email, user yang ingin upgrade role diharapkan bisa mengirimkan data-data yang valid untuk mendukung acc oleh admin-->
