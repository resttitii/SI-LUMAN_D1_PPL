                ...
                <div>
                    <div class="d-flex justify-content-between">
                        ...
                        @if (Auth::user()->role != 'admin')
                            ...
                            <div> <!--klik edit profile maka akan diarahkan ke halaman edit_profile.blade.php-->
                    ...
                    <!--edit profile hanya dilakukan oleh 3 role selain admin => semua data dapat diedit, tetapi untuk ubah pass bisa dilakukan pada bagian reset pass-->
                    <div class="mt-3">
