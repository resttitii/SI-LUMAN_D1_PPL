        ...
        <div class="col-xl-7 col-11 card p-0 mt-4" style="height: 80vh; overflow-y: auto">
            <div class="card-body px-4 py-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="dropdown"> <!--dropdown pada halaman konsultasi-->
                    ...
                    <!--tambah keluhan hanya untuk peternak dan pelanggan-->
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <!-- Modal --> <!--menghapus keluhan yang telah diinputkan-->
               ...
               <div class="col-12 text-center">
                    ...
                    <p class="text-muted">Belum ada data keluhan</p> <!--informasi jika belum terdapat data keluhan-->
                </div>
