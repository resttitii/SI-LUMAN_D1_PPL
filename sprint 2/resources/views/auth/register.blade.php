            ...
            @csrf
                <div>
                    <h5 class="text-center">
                        <strong>Buat Akun</strong> <!--register => nama, username, alamat, email, nomor hp, pass-->
                    </h5>
                    ...
                    <p class="text-center mb-0 mt-2" style="font-size: 13px">Sudah punya akun? <a href="{{ route('login') }}">Masuk di sini.</a></p> <!--jika sudah punya akun maka akan diarahkan ke halaman login.blade.php-->
                </div>
            </form>
        </div>
    </div>
