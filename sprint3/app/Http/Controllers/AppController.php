...
class AppController extends Controller
{
    ...
    public function toko()
    {
        $data = [
            'title' => 'Toko',
            'id_page' => 3,
            'all_produk' => Produk::with('user')->where('status', 'tersedia')->get(),
        ];
    ...
    public function update_role($user_id, Request $request)
    {
    ...
    public function buat_keluhan(Request $req)
    {
        $this->validate($req, [
            'question' => 'required'
        ], [
            'question.required' => 'Kolom input pertanyaan tidak boleh kosong!'
        ]);
        $keluhan = new Keluhan();
    ...
    public function hapus_keluhan($keluhan_id)
    {
    ...
    public function tanggapan($keluhan_id)
    {
        $keluhan = Keluhan::find($keluhan_id);
        $data = [
            'title' => 'Tanggapan',
    ...
    public function tambah_tanggapan($keluhan_id)
    {
        $data = [
    ...
    public function buat_tanggapan(Request $req)
    {
        $this->validate($req, [
            'comment' => 'required'
        ], [
            'comment.required' => 'Kolom input pertanyaan tidak boleh kosong!'
        ]);
        ...
        return redirect('/tanggapan/' . $req->keluhan_id)->with('success', 'Berhasil menanggapi pertanyaan');
    }
    ...
    public function hapus_keranjang()
    {
        ...
        return redirect()->back()->with('info', 'Berhasil menghapus produk di dalam keranjang!');
    }
