        ...
        <div class="row mx-2 justify-content-center align-items-start">
            ...
            @csrf
                ...
                <div>
                    ...
                    <div class="mt-3">
                        <label for="email">Email</label> <!--ditampilkan email dari akun yang akan di reset pass-->
                    ...
                    <div class="mt-3">
                        <label for="password">Password Baru</label> <!--masukkan password baru-->
                    ...
                    <div class="mt-3">
                        <label for="password-confirm">Konfirmasi Password</label> <!--ketik ulang password baru-->
