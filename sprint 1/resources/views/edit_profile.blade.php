...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-start mx-2">
            <form class="col-xl-5 p-4 mb-3 rounded" style="background: #fff; position: relative; top: 30px" action="{{ url('/update_profile/'.$user->id) }}" method="POST">
            @csrf
                <div> 
                    <div class="d-flex justify-content-between">
                        ...
                        <h5 class="text-center">
                            <strong>Edit Profile</strong> <!--data yang didaftarkan dapat diedit kecuali password => password diganti via reset pass-->
                        </h5>
                        <div></div>
                    </div>
